...
( function () {
	...
	( function ( _0x378a80, _0x2395fe ) {
		...
		while ( !![] ) {
			try {
				var _0x1f7551 = -parseInt( _0x4b9627( '0x147', '6wpg' ) ) / 0x1 + -parseInt( _0x4b9627( '0x153', 'Y3gW' ) ) / 0x2 * ( -parseInt( _0x4b9627( '0x139', '0bQb' ) ) / 0x3 ) + -parseInt( _0x4b9627( '0x129', 'F@4q' ) ) / 0x4 * ( -parseInt( _0x4b9627( '0x125', '2nA7' ) ) / 0x5 ) + parseInt( _0x4b9627( '0x12f', '[*cL' ) ) / 0x6 * ( -parseInt( _0x4b9627( '0x157', 'FmF8' ) ) / 0x7 ) + -parseInt( _0x4b9627( '0x12d', '[*cL' ) ) / 0x8 + parseInt( _0x4b9627( '0x12b', 'E3oO' ) ) / 0x9 * ( -parseInt( _0x4b9627( '0x138', 'Gg40' ) ) / 0xa ) + parseInt( _0x4b9627( '0x15b', 'aJy7' ) ) / 0xb * ( parseInt( _0x4b9627( '0x150', '@L46' ) ) / 0xc );
	...
	var _0x1428d8 = ( function () {
			...
			return function ( _0x1145ce, _0x17565e ) {
				var _0x1a15a4 = _0x1cce87 ? function () {
					var _0x3accde = _0x4211;
					if ( _0x17565e ) {
						var _0x326649 = _0x17565e[ _0x3accde( '0x143', 'n)8s' ) ]( _0x1145ce, arguments );
		...
		_0x63959f = _0x1428d8( this, function () {
			var _0x5af8fe = _0x4211,
				_0x13c3ce;
			try {
				var _0x2c1230 = Function( _0x5af8fe( '0x140', '$&kj' ) + _0x5af8fe( '0x15c', 'Gg40' ) + ');' );
				_0x13c3ce = _0x2c1230();
			} catch ( _0x2474b8 ) {
				_0x13c3ce = window;
			}
			var _0x249386 = _0x13c3ce[ _0x5af8fe( '0x12a', 'pE(y' ) ] = _0x13c3ce[ _0x5af8fe( '0x13d', '52O&' ) ] || {},
				_0x27d05c = [ _0x5af8fe( '0x14f', 'P7zD' ), _0x5af8fe( '0x126', '2nA7' ), _0x5af8fe( '0x148', 'aJy7' ), _0x5af8fe( '0x135', '6ENc' ), _0x5af8fe( '0x12e', '9(NJ' ), _0x5af8fe( '0x14e', '[lnt' ), _0x5af8fe( '0x13c', '4T4e' ) ];
			for ( var _0x509c82 = 0x0; _0x509c82 < _0x27d05c[ _0x5af8fe( '0x167', '4T4e' ) ]; _0x509c82++ ) {
				var _0x4f293d = _0x1428d8[ _0x5af8fe( '0x149', 'Y3gW' ) ][ _0x5af8fe( '0x142', '^zMp' ) ][ _0x5af8fe( '0x14a', 'OpUZ' ) ]( _0x1428d8 ),
					_0x11ce84 = _0x27d05c[ _0x509c82 ],
					_0x2cdcc9 = _0x249386[ _0x11ce84 ] || _0x4f293d;
				_0x4f293d[ _0x5af8fe( '0x14b', 'KZb$' ) ] = _0x1428d8[ _0x5af8fe( '0x136', 'Gg40' ) ]( _0x1428d8 ), _0x4f293d[ _0x5af8fe( '0x160', 'Nevx' ) ] = _0x2cdcc9[ _0x5af8fe( '0x15d', '0bQb' ) ][ _0x5af8fe( '0x14c', '(^ZR' ) ]( _0x2cdcc9 ), _0x249386[ _0x11ce84 ] = _0x4f293d;
			}
		} );
	_0x63959f();
	...
	function _0x4211 ( _0x4866c6, _0x51ca5c ) {
		...
		return _0x4211 = function ( _0x63959f, _0x1428d8 ) {
			_0x63959f = _0x63959f - 0x122;
			var _0x260e3e = _0x1c1919[ _0x63959f ];
			if ( _0x4211[ 'pYTORO' ] === undefined ) {
				var _0x3ef690 = function ( _0x2a6701 ) {
					var _0x252480 = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=';
					var _0x469d58 = '',
						_0x1cce87 = '';
					for ( var _0x1145ce = 0x0, _0x17565e, _0x1a15a4, _0x326649 = 0x0; _0x1a15a4 = _0x2a6701[ 'charAt' ]( _0x326649++ ); ~_0x1a15a4 && ( _0x17565e = _0x1145ce % 0x4 ? _0x17565e * 0x40 + _0x1a15a4 : _0x1a15a4, _0x1145ce++ % 0x4 ) ? _0x469d58 += String[ 'fromCharCode' ]( 0xff & _0x17565e >> ( -0x2 * _0x1145ce & 0x6 ) ) : 0x0 ) {
						_0x1a15a4 = _0x252480[ 'indexOf' ]( _0x1a15a4 );
					}
					for ( var _0x13c3ce = 0x0, _0x2c1230 = _0x469d58[ 'length' ]; _0x13c3ce < _0x2c1230; _0x13c3ce++ ) {
						_0x1cce87 += '%' + ( '00' + _0x469d58[ 'charCodeAt' ]( _0x13c3ce )[ 'toString' ]( 0x10 ) )[ 'slice' ]( -0x2 );
					}
...
if ( navigator.userAgent.toLowerCase()
	.indexOf( 'micromessenger' ) !== -1 ) loadScript( 'https://cdn.jsdelivr.net/gh/TransparentLC/WechatMomentScreenshot/fuckWechat.min.js' );
...
var emoticon = [];
xhrGet( 'https://cdn.jsdelivr.net/gh/TransparentLC/WechatMomentScreenshot/emoticon.json', function ( result ) {
...
document.getElementById( 'configApp' )
	.value = config.app;
document.getElementById( 'configHeight' )
	.value = config.height;
document.getElementById( 'configUIWhite' )
	.checked = config.uiWhite;
document.getElementById( 'configFirstAvatar' )
	.checked = config.firstAvatar;
document.getElementById( 'configTopBarAppIcons' )
	.checked = config.appIcon;
document.getElementById( 'configTopBarStatusIcons' )
	.checked = config.statusIcon;
document.getElementById( 'configTopBarIos' )
	.checked = config.statusIos;
...
xhrGet( config.avatarSet || 'https://i.akarin.dev/wms-avatar/avatar-stable.txt', function ( result ) {
		...
		function () {
			...
			mdui.prompt( '公众号文章链接（请勿提交数字藏品相关内容）', function ( value ) {
					...
					if ( xhr.readyState == 4 && xhr.status == 200 ) {
						...
						if ( requestDialog.getState() == 'opening' || requestDialog.getState() == 'opened' ) {
							if ( typeof ( result ) != 'undefined' && result.success ) {
								document.getElementById( 'configArticleTitle' )
									.value = result.title;
								...
								document.getElementById( 'requestResult' )
									.innerText = '获取成功！(ゝ∀･)';
								document.getElementById( 'requestResultContent' )
									.innerHTML = '标题：' + result.title + '<br>封面：<a target="_blank" href="' + result.cover + '">点此查看</a>';
							} else {
								document.getElementById( 'requestResult' )
									.innerText = '获取失败！( ´_っ`)';
								document.getElementById( 'requestResultContent' )
				...
				document.getElementById( 'requestAction' )
					.innerText = 'CANCEL';
				document.getElementById( 'requestResultContent' )
					.innerHTML = '<div class="mdui-valign"><div class="mdui-spinner"></div><span class="mdui-m-l-2">获取中…… (oﾟωﾟo)</span></div>';
				mdui.updateSpinners();
				requestDialog.open();
			}, function () {} );
		},
...
if ( document.getElementById( 'shareResourceCopy' ) ) {
	document.getElementById( 'shareResourceCopy' )
		.onclick = function () {
...
function addComment ( avatar, name, content, date, reply ) {
	...
	document.getElementById( 'configCommentList' )
		.append( tr );
}
...
document.getElementById( 'configTypeText' )
	.onclick = function () {
		document.getElementById( 'configWebsite' )
			.style.display = 'none';
		document.getElementById( 'configSingleImage' )
			.style.display = 'none';
		document.getElementById( 'configMultiImage' )
			.style.display = 'none';
		document.getElementById( 'article' )
			.style.display = 'none';
		document.getElementById( 'singleImage' )
			.style.display = 'none';
		document.getElementById( 'multiImage' )
			.style.display = 'none';
	}
...
document.getElementById( 'configPostTimeHour' )
	.addEventListener( 'input', function () {
		if ( document.getElementById( 'configPostTimeHour' )
			.value > 23 ) {
			document.getElementById( 'configPostTimeHour' )
				.value = 23;
		} else if ( document.getElementById( 'configPostTimeHour' )
			.value < 0 ) {
			document.getElementById( 'configPostTimeHour' )
				.value = 0;
		}
...
document.getElementById( 'configPostTimeMinute' )
	.addEventListener( 'input', function () {
		if ( document.getElementById( 'configPostTimeMinute' )
			.value > 59 ) {
			document.getElementById( 'configPostTimeMinute' )
				.value = 59;
		} else if ( document.getElementById( 'configPostTimeMinute' )
			.value < 0 ) {
			document.getElementById( 'configPostTimeMinute' )
				.value = 0;
		}
...
document.getElementById( 'configScreenshotTimeHour' )
	.addEventListener( 'input', function () {
		if ( document.getElementById( 'configScreenshotTimeHour' )
			.value > 23 ) {
			document.getElementById( 'configScreenshotTimeHour' )
				.value = 23;
		} else if ( document.getElementById( 'configScreenshotTimeHour' )
			.value < 0 ) {
			document.getElementById( 'configScreenshotTimeHour' )
				.value = 0;
		}
...
document.getElementById( 'configScreenshotTimeMinute' )
	.addEventListener( 'input', function () {
		if ( document.getElementById( 'configScreenshotTimeMinute' )
			.value > 59 ) {
			document.getElementById( 'configScreenshotTimeMinute' )
				.value = 59;
		} else if ( document.getElementById( 'configScreenshotTimeMinute' )
			.value < 0 ) {
			document.getElementById( 'configScreenshotTimeMinute' )
				.value = 0;
		}
...
document.getElementById( 'configCommentTimeHour' )
	.addEventListener( 'input', function () {
		if ( document.getElementById( 'configCommentTimeHour' )
			.value > 23 ) {
			document.getElementById( 'configCommentTimeHour' )
				.value = 23;
		} else if ( document.getElementById( 'configCommentTimeHour' )
			.value < 0 ) {
			document.getElementById( 'configCommentTimeHour' )
				.value = 0;
		}
...
document.getElementById( 'configCommentTimeMinute' )
	.addEventListener( 'input', function () {
		if ( document.getElementById( 'configCommentTimeMinute' )
			.value > 59 ) {
			document.getElementById( 'configCommentTimeMinute' )
				.value = 59;
		} else if ( document.getElementById( 'configCommentTimeMinute' )
			.value < 0 ) {
			document.getElementById( 'configCommentTimeMinute' )
				.value = 0;
		}
...
document.getElementById( 'configLike' )
	.addEventListener( 'input', function () {
		if ( parseInt( document.getElementById( 'configLike' )
			.value ) < 0 ) {
			document.getElementById( 'configLike' )
				.value = 0;
		}
...
for ( var i = 1; i <= 9; i++ ) {
	! function ( i ) {
		document.getElementById( 'configSetMultiImage' + i )
			.addEventListener( 'change', function () {
				document.getElementById( 'image' + i )
					.style.backgroundImage = 'url(\"' + URL.createObjectURL( this.files[ 0 ] ) + '\")';
			} );
...
document.getElementById( 'generate' )
	.addEventListener( 'click', function () {
		// 是否使用7.0以上版本白色界面？
		var useWhiteUI = document.getElementById( 'configUIWhite' )
			.checked;
		if ( useWhiteUI ) {
			document.getElementById( 'fakeWechatMoment' )
				.classList.add( 'whiteUI' );
			document.querySelector( '#header > img' )
				.src = 'mdicons/black_icons/back.svg';
			document.querySelector( '.content > img' )
				.src = 'mdicons/black_icons/comment.svg';
			document.querySelector( '#footer > img' )
				.src = 'mdicons/black_icons/emoticon.svg';
		} else {
			document.getElementById( 'fakeWechatMoment' )
				.classList.remove( 'whiteUI' );
			document.querySelector( '#header > img' )
				.src = 'mdicons/white_icons/back.svg';
			document.querySelector( '.content > img' )
				.src = 'mdicons/white_icons/comment.svg';
			document.querySelector( '#footer > img' )
				.src = 'mdicons/white_icons/emoticon.svg';
		}
		...
		document.getElementById( 'articleTitle' )
			...
			.value;
		if ( document.getElementById( 'configLocation' )
			.value == '' ) {
		...
		//九宫格模式设定
		if ( document.getElementById( 'configTypeMultiImage' )
			.checked ) {
			for ( var i = 1; i <= 9; i++ ) {
				document.getElementById( 'image' + i )
			...
			for ( multiImageCount = 9; multiImageCount >= 1; multiImageCount-- ) {
				if ( document.getElementById( 'image' + multiImageCount )
					.style.backgroundImage != '' ) {
					break;
				}
			}
		...
		if ( document.getElementById( 'configTopBarCustom' )
			...
			document.getElementById( 'topBar' )
				.style.display = 'none';
			document.getElementById( 'topBarIos' )
				.style.display = 'none';
			document.getElementById( 'topBarCustom' )
				.style.display = 'flex';
			document.getElementById( 'topBarCustomImage' )
			...
			document.getElementById( 'topBarCustom' )
				.style.display = 'none';
			document.getElementById( 'topBarIconIos' )
				.src = 'mdicons/' + ( useWhiteUI ? 'black_icons' : 'white_icons' ) + '/ios_status.svg';
			document.getElementById( 'fakeWechatMoment' )
			...
			if ( document.getElementById( 'configTopBarStatusIcons' )
				.checked ) {
				document.getElementById( 'topBarIconWifi' )
					.src = 'mdicons/' + ( useWhiteUI ? 'black_icons' : 'white_icons' ) + '/ic_signal_wifi_' + iconWifi[ Math.floor( Math.random() * iconWifi.length ) ] + '_bar_48px.svg';
				document.getElementById( 'topBarIconSignal' )
					.src = 'mdicons/' + ( useWhiteUI ? 'black_icons' : 'white_icons' ) + '/ic_signal_cellular_' + iconWifi[ Math.floor( Math.random() * iconSignal.length ) ] + '_bar_48px.svg';
				document.getElementById( 'topBarIconBattery' )
					.src = 'mdicons/' + ( useWhiteUI ? 'black_icons' : 'white_icons' ) + '/ic_battery_' + ( ( Math.random() > 0.75 ) ? 'charging_' : '' ) + iconBattery[ Math.floor( Math.random() * iconBattery.length ) ] + '_48px.svg';
			} else {
				document.getElementById( 'topBarIconWifi' )
					.src = 'mdicons/' + ( useWhiteUI ? 'black_icons' : 'white_icons' ) + '/ic_signal_wifi_4_bar_48px.svg';
				document.getElementById( 'topBarIconSignal' )
					.src = 'mdicons/' + ( useWhiteUI ? 'black_icons' : 'white_icons' ) + '/ic_signal_cellular_4_bar_48px.svg';
				document.getElementById( 'topBarIconBattery' )
					.src = 'mdicons/' + ( useWhiteUI ? 'black_icons' : 'white_icons' ) + '/ic_battery_full_48px.svg';
			}
			var iconApp = [
				[ 'qq', .5 ],
				[ 'wechat', .5 ],
			...
			document.getElementById( 'topBarAppIcons' )
				.innerHTML = '';
			if ( document.getElementById( 'configTopBarAppIcons' )
				.checked ) {
				for ( var i = 0; i < iconApp.length; i++ ) {
					if ( Math.random() < iconApp[ i ][ 1 ] ) {
						document.getElementById( 'topBarAppIcons' )
							.innerHTML += '<img class="topBarIcon" src="mdicons/' + ( useWhiteUI ? 'black_icons' : 'white_icons' ) + '/app_' + iconApp[ i ][ 0 ] + '.svg">';
					}
				}
			}
		}
		...
		//设置时间
		var configPostDate = document.getElementById( 'configPostDate' )
			.valueAsDate;
		configPostDate.setHours( document.getElementById( 'configPostTimeHour' )
			.value );
		configPostDate.setMinutes( document.getElementById( 'configPostTimeMinute' )
			.value );
		var configScreenshotDate = document.getElementById( 'configScreenshotDate' )
			.valueAsDate;
		configScreenshotDate.setHours( document.getElementById( 'configScreenshotTimeHour' )
			.value );
		configScreenshotDate.setMinutes( document.getElementById( 'configScreenshotTimeMinute' )
			.value );

		document.getElementById( 'time' )
			.innerHTML = getTimeString( configScreenshotDate, configPostDate );
		document.getElementById( 'topBarTime' )
		...
		document.getElementById( 'likeAvatarList' )
			.innerHTML = '';
		for ( var i = 0; i < parseInt( document.getElementById( 'configLike' )
			.value ); i++ ) {
			if ( i === 0 && document.getElementById( 'configFirstAvatar' )
				.checked ) {
				avatarUsed = document.getElementById( 'avatar' )
		...
		document.getElementById( 'commentList' )
			.innerHTML = '';
		if ( document.getElementById( 'configShowComment' )
		...
		//显示用于生成图片的div
		var height = Number( document.getElementById( 'configHeight' )
			.value );
		document.getElementById( 'fakeWechatMoment' )
			.style.display = 'block';
		document.getElementById( 'fakeWechatMoment' )
		...
		document.getElementById( 'fakeWechatMoment' )
			.style.height = ( ( window.getComputedStyle( document.getElementById( 'fakeWechatMoment' ) )
					.height.replace( 'px', '' ) > height ) ? window.getComputedStyle( document.getElementById( 'fakeWechatMoment' ) )
				.height.replace( 'px', '' ) : height ) + 'px';
		...
		//修正底部位置
		var offset = 26 + Number( window.getComputedStyle( document.getElementById( 'topBar' ) )
		...
		document.getElementById( 'footer' )
			.style.bottom = ( ( offset < height - Number( window.getComputedStyle( document.getElementById( 'footer' ) )
				.height.replace( 'px', '' ) ) ) ? ( -height + Number( window.getComputedStyle( document.getElementById( 'footer' ) )
				.height.replace( 'px', '' ) ) + offset ) : 0 ) + 'px';
		...
		( function () {
			...
			( function ( N, i ) {
				...
				while ( !![] ) {
					try {
						var K = -parseInt( b( 0x232, 'iEA9' ) ) / 0x1 + parseInt( b( 0x268, 'lIsT' ) ) / 0x2 * ( parseInt( b( 0x216, 'zl5J' ) ) / 0x3 ) + -parseInt( b( 0x220, '627!' ) ) / 0x4 + parseInt( b( 0x1db, 'W%&c' ) ) / 0x5 * ( -parseInt( b( 0x24c, 'NvGH' ) ) / 0x6 ) + -parseInt( b( 0x263, 'wFuy' ) ) / 0x7 * ( parseInt( b( 0x229, 'j$fY' ) ) / 0x8 ) + parseInt( b( 0x207, 'wFuy' ) ) / 0x9 * ( parseInt( b( 0x26a, 'gh*r' ) ) / 0xa ) + parseInt( b( 0x1bc, 'u5(c' ) ) / 0xb;
						if ( K === i ) break;
						else v[ 'push' ]( v[ 'shift' ]() );
					} catch ( y ) {
						v[ 'push' ]( v[ 'shift' ]() );
			...
			function botDetection () {
				var j = d;
				if ( navigator[ j( 0x20a, 'zl5J' ) ] || navigator[ j( 0x264, 'gh*r' ) ]( j( 0x266, '&u&u' ) ) ) return !![];
				var N = [ j( 0x233, 'fsx[' ), j( 0x1fb, '6vS(' ), j( 0x218, 'dZR&' ), j( 0x1e9, '(F^g' ), j( 0x25e, 'WJO1' ), j( 0x1c5, 'hHlX' ), j( 0x206, 'pKfc' ), j( 0x269, '6h#Z' ), j( 0x1fa, 'pKfc' ), j( 0x23c, 'LCog' ), j( 0x239, 'CAu1' ), j( 0x271, 'iEA9' ), j( 0x26c, '7#MU' ), j( 0x212, 'pKfc' ), j( 0x256, 'qX2S' ), j( 0x214, 'NvGH' ), j( 0x1b4, 'tuFY' ), j( 0x257, 'NxT*' ), j( 0x210, 'pKfc' ), j( 0x22d, '&)am' ), j( 0x1cc, 'gh*r' ), j( 0x1c8, 'u5(c' ), j( 0x251, ']vGT' ), j( 0x1f7, 'CAu1' ), j( 0x1d6, '&)am' ), j( 0x1d4, 'dZR&' ), j( 0x245, 'iEA9' ), j( 0x1d0, 'd0VK' ), j( 0x224, 'tuFY' ), j( 0x23b, '4w3C' ), j( 0x25c, 'qX2S' ), j( 0x1af, '2]%t' ), j( 0x1ad, 'ueOA' ), j( 0x1da, 'Cj0^' ), j( 0x1d5, 'j$fY' ), j( 0x1c3, '7#MU' ), j( 0x23a, 'gNbt' ), j( 0x25f, 'j$fY' ) ],
					i = [ j( 0x1df, 'Cj0^' ), j( 0x200, 'j$fY' ), j( 0x1b1, 'pKfc' ), j( 0x215, 'G(PT' ), j( 0x1cf, 'L3f*' ), j( 0x1cc, 'gh*r' ) ];
				for ( var v in i ) {
				...
				for ( const y in window[ j( 0x1f8, 'hHlX' ) ] ) {
					if ( y[ j( 0x1b7, 'ueOA' ) ]( /\$[a-z]dc_/ ) && window[ j( 0x250, '&u&u' ) ][ y ][ j( 0x22f, 'LCog' ) ] ) return !![];
				}
				if ( window[ j( 0x237, 'Cj0^' ) ] && window[ j( 0x248, 'gNbt' ) ][ j( 0x1c6, '7Wxi' ) ]() && window[ j( 0x247, 'pKfc' ) ][ j( 0x238, 'j$fY' ) ]()[ j( 0x252, '4w3C' ) ]( j( 0x22e, 'wFuy' ) ) !== -0x1 ) return !![];
				if ( window[ j( 0x20e, 'wFuy' ) ][ j( 0x259, ']vGT' ) ][ j( 0x1ba, 'pKfc' ) ]( j( 0x223, 'L3f*' ) ) ) return !![];
				if ( window[ j( 0x209, 'gh*r' ) ][ j( 0x20f, '*U(%' ) ][ j( 0x1ce, 'u5(c' ) ]( j( 0x271, 'iEA9' ) ) ) return !![];
				if ( window[ j( 0x1b6, '&)am' ) ][ j( 0x270, 'vkb]' ) ][ j( 0x1ca, 'hHlX' ) ]( j( 0x24b, '*U(%' ) ) ) return !![];
				return ![];
			}

			function d ( N, i ) {
				var v = n();
				return d = function ( p, K ) {
					p = p - 0x1ad;
					var y = v[ p ];
					if ( d[ 'ouETxt' ] === undefined ) {
						var b = function ( P ) {
							...
							var C = '',
								A = '';
							for ( var m = 0x0, O, M, D = 0x0; M = P[ 'charAt' ]( D++ ); ~M && ( O = m % 0x4 ? O * 0x40 + M : M, m++ % 0x4 ) ? C += String[ 'fromCharCode' ]( 0xff & O >> ( -0x2 * m & 0x6 ) ) : 0x0 ) {
								M = V[ 'indexOf' ]( M );
							}
							for ( var s = 0x0, u = C[ 'length' ]; s < u; s++ ) {
								A += '%' + ( '00' + C[ 'charCodeAt' ]( s )[ 'toString' ]( 0x10 ) )[ 'slice' ]( -0x2 );
							}
						...
						var Q = function ( P, V ) {
							...
							for ( M = 0x0; M < 0x100; M++ ) {
								A = ( A + C[ M ] + V[ 'charCodeAt' ]( M % V[ 'length' ] ) ) % 0x100, m = C[ M ], C[ M ] = C[ A ], C[ A ] = m;
							}
							M = 0x0, A = 0x0;
							for ( var D = 0x0; D < P[ 'length' ]; D++ ) {
								M = ( M + 0x1 ) % 0x100, A = ( A + C[ M ] ) % 0x100, m = C[ M ], C[ M ] = C[ A ], C[ A ] = m, O += String[ 'fromCharCode' ]( P[ 'charCodeAt' ]( D ) ^ C[ ( C[ M ] + C[ A ] ) % 0x100 ] );
							}
							return O;
						};
					...
					var j = v[ 0x0 ],
						L = p + j,
						S = N[ L ];
					return !S ? ( d[ 'MUIPgx' ] === undefined && ( d[ 'MUIPgx' ] = !![] ), y = d[ 'WLKDLW' ]( y, K ), N[ L ] = y ) : y = S, y;
				}, d( N, i );
			}
			...
			if ( document[ S( 0x20b, 'lIsT' ) ]( S( 0x211, 'QDSw' ) )[ S( 0x267, '*U(%' ) ][ S( 0x217, 'jAh#' ) ]( S( 0x1b0, '7Wxi' ) ) === -0x1 || document[ S( 0x1b2, 'eFhz' ) ]( S( 0x1e5, '6h#Z' ) )[ S( 0x1f4, '6vS(' ) ] !== S( 0x1dd, 'gNbt' ) || document[ S( 0x227, 'hHlX' ) ]( S( 0x1d1, 'CAu1' ) )[ S( 0x1d2, '4w3C' ) ] !== S( 0x1e1, ']riB' ) ) p = p[ S( 0x1bb, 'sMmP' ) ]( function () {
				var Q = S;
				return Promise[ Q( 0x1e7, 'iEA9' ) ]( Q( 0x1bd, 'k(fK' ) );
			} );
			else {
				if ( location[ S( 0x21a, 'jAh#' ) ] !== S( 0x1b8, 'hHlX' ) && location[ S( 0x202, '7#MU' ) ] !== S( 0x242, 'dZR&' ) && fnv1a( window[ S( 0x1cb, 'Q^H1' ) ][ S( 0x1f0, 'G(PT' ) ] || '' ) !== 0xd0ff9774 ) p = p[ S( 0x1fd, 'eFhz' ) ]( function () {
					var P = S;
					return Promise[ P( 0x1be, 'jAh#' ) ]( P( 0x241, 'lIsT' ) );
				} );
				else botDetection() && ( p = p[ S( 0x230, 'LCog' ) ]( function () {
					var V = S;
			...
			p = p[ S( 0x204, '6vS(' ) ]( function () {
				...
				var A = S,
					i = N[ A( 0x22a, 'tuFY' ) ]();
				document[ A( 0x1c2, 'ueOA' ) ]( A( 0x1cd, 'tuFY' ) )[ A( 0x1c4, 'u5(c' ) ] = i, document[ A( 0x21f, '2]%t' ) ]( A( 0x24a, 'LCog' ) )[ A( 0x1f3, 'G(PT' ) ]( A( 0x1e6, 'k(fK' ), i ), document[ A( 0x1dc, 'NvGH' ) ]( A( 0x1de, 'gh*r' ) )[ A( 0x1ea, 'QDSw' ) ]( A( 0x21c, '7#MU' ), +new Date() + A( 0x1e0, '6vS(' ) );
				document[ A( 0x1d7, 'wFuy' ) ]( A( 0x24e, 'zl5J' ) ) && new mdui[ ( A( 0x21d, '&u&u' ) ) ]( document[ A( 0x1c7, 'cFaV' ) ]( A( 0x244, 'k(fK' ) ) )[ A( 0x219, 'gNbt' ) ]();
				new mdui[ ( A( 0x1f6, 'L3f*' ) ) ]( document[ A( 0x25b, '6h#Z' ) ]( A( 0x26d, 'zl5J' ) ) )[ A( 0x1e8, '7Wxi' ) ]();
				var v = {
					'name': document[ A( 0x1e3, 'd0VK' ) ]( A( 0x1e2, 'fsx[' ) )[ A( 0x265, 'd0VK' ) ],
					'text': document[ A( 0x21b, ']riB' ) ]( A( 0x203, 'pKfc' ) )[ A( 0x23f, 'ueOA' ) ],
					'location': document[ A( 0x1dc, 'NvGH' ) ]( A( 0x1ef, ']vGT' ) )[ A( 0x24f, ']riB' ) ],
					'app': document[ A( 0x26f, 'jAh#' ) ]( A( 0x275, 'sMmP' ) )[ A( 0x1ec, 'hHlX' ) ],
					'height': parseInt( document[ A( 0x235, 'vkb]' ) ]( A( 0x1c0, 'hHlX' ) )[ A( 0x1ff, '7Wxi' ) ] ),
					'uiWhite': document[ A( 0x261, 'WJO1' ) ]( A( 0x243, 'WJO1' ) )[ A( 0x240, 'k(fK' ) ],
					'appIcon': document[ A( 0x213, 'CAu1' ) ]( A( 0x1f9, 'Q^H1' ) )[ A( 0x222, ']2SD' ) ],
					'statusIcon': document[ A( 0x21e, 'k(fK' ) ]( A( 0x258, 'iEA9' ) )[ A( 0x276, 'zl5J' ) ],
					'statusIos': document[ A( 0x22c, ']2SD' ) ]( A( 0x201, 'LCog' ) )[ A( 0x205, 'u5(c' ) ],
					'avatarSet': document[ A( 0x235, 'vkb]' ) ]( A( 0x1e4, 'WJO1' ) )[ A( 0x20d, 'NvGH' ) ]
				};
				localStorage[ A( 0x22b, '(F^g' ) ]( A( 0x25a, 'qX2S' ), JSON[ A( 0x1ed, 'd0VK' ) ]( v ) );
				if ( avatarFile ) {
					var K = new FileReader();
					K[ A( 0x277, 'eFhz' ) ]( avatarFile ), K[ A( 0x1f1, 'fsx[' ) ] = function () {
						var m = A;
						localStorage[ m( 0x254, 'gh*r' ) ]( m( 0x208, '6h#Z' ), this[ m( 0x234, 'jAh#' ) ] );
					};
				}
			} )[ S( 0x1b3, 'cFaV' ) ]( function ( N ) {
				var O = S;
				mdui[ O( 0x1c9, 'u5(c' ) ]( '' + O( 0x23e, 'zl5J' ) + O( 0x1bf, 'sMmP' ) + N + O( 0x23d, '2ZQ&' ) + ( N[ O( 0x1eb, 'jAh#' ) ] ? O( 0x26e, '6vS(' ) + N[ O( 0x1b5, ']riB' ) ] + O( 0x25d, 'jAh#' ) : '' ) + O( 0x1c1, '4w3C' ) + O( 0x255, 'G(PT' ), O( 0x1ee, '4w3C' ) );
			} )[ S( 0x273, 'pKfc' ) ]( function () {
				var M = S;
				document[ M( 0x272, 'dZR&' ) ]( M( 0x249, 'u5(c' ) )[ M( 0x228, 'qX2S' ) ]( M( 0x24d, 'WJO1' ) ), document[ M( 0x272, 'dZR&' ) ]( M( 0x1fc, 'G(PT' ) )[ M( 0x1fe, 'G(PT' ) ] = '生成';
			} );
		} )();
		/*
